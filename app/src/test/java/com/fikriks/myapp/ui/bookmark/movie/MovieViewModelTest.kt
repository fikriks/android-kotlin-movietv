...
class MovieViewModelTest{
    ...
    fun `getMovies should be success`() {
        ...
        `when`(movieRepository.getBookmarkedMovies()).thenReturn(expected)
    ...
    fun setBookmark() {
        ...
        viewModel.setBookmark(movieEntities)

        verify(movieRepository, Mockito.times(1)).setMovieBookmark(movieEntities, true)
    }
